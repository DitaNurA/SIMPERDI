    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="nav-icon fas fa-copy"></i> Tambah SPJ Dalam Daerah</h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <section class="content">
            ...
            <form action="{{ route('proses_spj_dalam_tambah') }}" method="POST" enctype="multipart/form-data">
                @csrf
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-5">
                                                <select class="form-control" name="no_sppd" id="no_sppd" required>
                                                    ...
                                                    @php
                                                        $sppd = DB::table('rincian_sppd_dalam')->get();
                                                    @endphp
                                                    @foreach ($sppd as $t)
