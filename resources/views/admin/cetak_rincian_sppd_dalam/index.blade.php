            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <h1><i class="fas fa-users"></i> Cetak Rincian SPPD Dalam Daerah</h1>
        ...
        <section class="content">
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <div class="card-title">Cetak Rincian SPPD Dalam Daerah</div>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered" id="example1">
                            ...
                            <tbody>
                                @foreach ($index as $i)
                                    <tr>
                                        <td>
                                            <a href="{{ route('rincian_sppd_cetak2_dalam', $i->id) }}"
