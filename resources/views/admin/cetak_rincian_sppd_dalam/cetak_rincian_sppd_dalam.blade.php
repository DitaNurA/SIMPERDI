...
<head>
    <title>Rincian SPPD Dalam Daerah</title>
    <style type="text/css">
        table {
...
<body onload="print()">
    ...
    @foreach ($rinciansppddalam as $item)
                    ...
                    <table width="90%">
                        ...
                        <tr>
                            ...
                            <td> 
                                <font style="font-family: Tahoma; font-size:11; text-align: left;"><b>
                                @php
                                $pegawai = DB::select('SELECT nama_lengkap FROM pegawai WHERE jabatan = "PPTK";');
                                @endphp
                                @foreach ($pegawai as $pegawai)
                            ...
                            @endforeach</b>
                                ...
                                <font style="font-family: Tahoma; font-size:12; text-align: left;">
                                @php
                                $pegawai = DB::select('SELECT jabatan FROM pegawai WHERE jabatan = "PPTK";');
                                @endphp
                                @foreach ($pegawai as $pegawai)
                                {{ $pegawai->jabatan }}<br>
                            @endforeach
                                ...
                                <font style="font-family: Tahoma; font-size:10; text-align: left;">
                                @php
                                $pegawai = DB::select('SELECT nip FROM pegawai WHERE jabatan = "PPTK";');
                                @endphp
                                @foreach ($pegawai as $pegawai)
                                {{ $pegawai->nip }}<br>
                            @endforeach
