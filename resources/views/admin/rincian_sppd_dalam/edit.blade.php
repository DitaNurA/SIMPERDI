    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="nav-icon fas fa-copy"></i> Edit Rincian SPPD Dalam Daerah</h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <section class="content">
            ...
            <form action="{{ route('proses_rincian_sppd_dalam_edit', $edit->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
