...
@section('title', 'Rincian SPPD Dalam')
@section('content')
<div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6" style="font-size:12px;">
                        ...
                        <h1><i class="fas fa-copy"></i> Rincian SPPD Dalam Daerah</h1>
        ...
        <section class="content">
            <!-- Default box -->
            <a href="{{ route('rincian_sppd_dalam_tambah') }}" class="btn btn-sm btn-success mb-2"><i class="fas fa-plus"></i>
                Tambah
                Data</a>
                        ...
                        <table class="table table-bordered" id="example1">
                            ...
                            <tbody>
                                @foreach ($index as $i)
                                    ...
                                    <a href="{{ route('rincian_sppd_dalam_edit', $i->id) }}"
                                    ...
                                    <p>
                                        <button type="button" class="btn btn-info" style="width: 70px; height: 23px; font-size:10px;"
                                                id="btnRincianSppdDalam" data-id="{{ $i->id }}" onclick="modalRincianSppdDalam({{ $i->id }})"><i class="fa fa-eye"></i> Detail</button>
    ...
    @include('admin.modal.rincian_sppd_dalam_modal')

<script>
    function modalRincianSppdDalam(id) {
        $("#modalRincianSppdDalam").modal();
        $.ajax({
                type: "GET",
                url: "{{ route('get_rincian_sppd_dalam') }}",
                data: {
                    "_token": "{{ csrf_token() }}",
                    "id": id
                },
                ...
                $("#tableRincianSppdDalam").html(html)
            }
        });
    }
</script>
