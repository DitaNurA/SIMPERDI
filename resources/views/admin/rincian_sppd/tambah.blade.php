    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="nav-icon fas fa-copy"></i> Tambah Rincian SPPD Luar Daerah</h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <section class="content">
            ...
            <form action="{{ route('proses_rincian_sppd_tambah') }}" method="POST" enctype="multipart/form-data">
                @csrf
            ...
            $("#no_sppd").change(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#instansiTujuan').val(response.tempat_tujuan)
