...
@section('title', 'Edit Rincian SPPD')
@section('content')
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="nav-icon fas fa-copy"></i> Edit Rincian SPPD Luar Daerah</h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <section class="content">
            ...
            <form action="{{ route('proses_rincian_sppd_edit', $edit->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card card-primary card-outline">
                                ...
                                <form action="" method="POST">
                                    ...
                                    <fieldset style="border: 1px solid #ccc; padding: 15px;">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="text" name="uang_harian" value="{{ $edit->uang_harian }}" id="uangHarian" class="form-control form-control-sm" required>
                                            </div>
                                            <div class="col-sm-1">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="text" name="transport_pp" value="{{ $edit->transport_pp }}"
                                        ...
                                        <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <input type="text" name="biaya_penginapan" value="{{ $edit->biaya_penginapan }}" id="biayaPenginapan"
                                                            class="form-control form-control-sm" required>
                                                    </div>
                                                    <div class="col-sm-1">
                                                        <button type="button" class="btn btn-dark btn-sm"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="text" name="belanja_bbm" value="{{ $edit->belanja_bbm }}" id="belanjaBBM"
                                        ...
                                        <div class="mb-3 row">
                                            <label for="biayaRepresentase" class="col-sm-3 col-form-label">5. Biaya
                                                Representase</label>
                                            <div class="col-sm-2">
                                                <input type="text" name="biaya_representase" value="{{ $edit->biaya_representase }}" id="biayaRepresentase"
                                                    class="form-control form-control-sm" required>
                                            </div>
                                            <div class="col-sm-1">
                                                        <button type="button" class="btn btn-dark btn-sm"
                                        ...
                                        <div class="col-sm-12">
                                            <input type="hidden" name="total_perjalanan_dinas" value="{{ $edit->total_perjalanan_dinas }}" id="inputanPerjalananDinas">
                                    ...
                                    <fieldset style="border: 1px solid #ccc; padding: 15px;">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" name="daerah_tujuan" value="{{ $edit->daerah_tujuan }}" id="daerahTujuan"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" name="instansi_tujuan" value="{{ $edit->instansi_tujuan }}" id="instansiTujuan"
                                                    class="form-control form-control-sm" required>
                                            </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" name="kode_rekening" value="{{ $edit->kode_rekening }}" id="kodeRekening"
                                                    class="form-control form-control-sm" required>
                                            </div>
                                            @error('kode_rekening')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-3">
                                                <input name="keperluan" value="{{ $edit->keperluan }}" id="keperluan" cols="30" rows="3"
                                                    class="form-control" required>
                                            </div>
                                            @error('keperluan')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" name="nominal_total" value="{{ $edit->nominal_total }}" id="nominal_total"
                                                    class="form-control form-control-sm" required>
                                            </div>
                                            @error('nominal_total')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" name="bayar_awal" value="{{ $edit->bayar_awal }}" id="bayar_awal"
                                                    class="form-control form-control-sm" required>
                                            </div>
                                            @error('bayar_awal')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" name="sisa" value="{{ $edit->sisa }}" id="sisa"
                                                    class="form-control form-control-sm" required>
                                            </div>
                                            @error('sisa')
                                                <div class="alert alert-danger">{{ $message }}</div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('kelola_rincian_sppd') }}" class="btn btn-warning">Back</a>
                    </div>
                </div>
            </form>
        </section>
