...
@section('title', 'Tambah Pegawai Surat Dalam')
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form action="{{ route('proses_detail_dalam_tambah', $surat->id) }}" method="POST">
                @csrf
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <div class="card-title">Surat Tugas {{ $surat_dalam->no_surat_tugas }}</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-10">
                                ...
                                <div class="row mt-2 mb-2">
                                    ...
                                    <div class="col">
                                        <input type="hidden" name="surat_tugas_dalam_id" value="{{ $surat->id }}">
