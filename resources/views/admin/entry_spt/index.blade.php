            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6" style="font-size:12px;">
                        ...
                        <h1><i class="fas fa-copy"></i> Entry Surat Tugas Luar Daerah</h1>
                                        ...
                                        <td>
                                            <div style="display: flex;">
                                                <a href="{{ route('detail_surat', $i->id) }}" onclick="lala();"
                                                    class="btn btn-sm btn-info mb-2 "  style="width: 70px; height: 23px; font-size:10px;"><i class="fas fa-eye"></i>
                                                    Lihat Pegawai</a>
                                            </div>
