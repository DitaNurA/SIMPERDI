...
class SuratTugasController extends Controller
{
    public function index()
    {
        ...
        return view('admin.entry_spt.index', compact('index'));
    }
    ...
    public function cetak(){
        ...
        return view('admin.cetak_surat_tugas.index', compact('index'));
    }

    public function create()
    {
        return view('admin.entry_spt.tambah');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.entry_spt.edit', compact('edit'));
    }
