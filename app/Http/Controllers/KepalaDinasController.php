...
class KepalaDinasController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.kepala_dinas.index', compact('index'));
    }
    ...
    {
        $Jabatan = Jabatan::all();
        return view('admin.kepala_dinas.tambah', compact('Jabatan'));
    }
    ...
    public function edit($id)
    {
        ...
        $Jabatan = Jabatan::all();
        return view('admin.kepala_dinas.edit', compact('edit', 'Jabatan'));
    }
    ...
    {
        $delete = KepalaDinas::find($id)->delete();
