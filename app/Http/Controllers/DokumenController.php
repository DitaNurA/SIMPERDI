...
class DokumenController extends Controller
{
    ...
    {
        $index = dokumen::all();
        return view('admin.dokument.index', compact('index'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.dokument.tambah', compact('Jabatan','kepaladinas'));
    }

    public function ajax()
    {
        if ($_POST['document'] == 'Non-PNS') {
            $pangkat = "-";
        } elseif ($_POST['document'] == 'IA') {
            $pangkat = 'Juru Muda';
    ...
    public function edit($id)
    {
        ...
        $Jabatan = Jabatan::all();
        $kepaladinas= KepalaDinas::all();
        return view('admin.dokument.edit', compact('edit', 'Jabatan', 'kepaladinas'));
    }
